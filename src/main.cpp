...
const string strMessageMagic = "thepinkcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "thepinkcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "thepinkcoin.com Block";
        CTransaction txNew;
        txNew.nTime = 1513561020;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1513561020;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2226606;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xf784c7e5e5771ca986d613eaaeff165f391fb999cd43e7acaebebd7f787bce03"));
        block.print();
